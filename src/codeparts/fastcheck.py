...
class fastcheck:
    ...
    def printinfo(self):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(f'Valorant Combo Checker by Settine  |  Checked {self.checked}/{self.count}  |  {self.cpmtext} CPM  |  Hitrate {percent}  |  Est. time: {self.esttime}')
        os.system('cls')
        print(f'''
    {reset}
    {syst.center('https://github.com/Settine/Valorant-Combo-Checker')}
