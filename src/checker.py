...
''')
    ...
    def printinfo(self):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(
            f'Settine {self.version}  |  Checked {self.checked}/{self.count}  |  {self.cpmtext} CPM  |  Hitrate {percent}  |  Est. time: {self.esttime}')
        os.system('cls')
        print(f'''
    {reset}
    {sys.center('https://github.com/Settine/Valorant-Combo-Checker')}
